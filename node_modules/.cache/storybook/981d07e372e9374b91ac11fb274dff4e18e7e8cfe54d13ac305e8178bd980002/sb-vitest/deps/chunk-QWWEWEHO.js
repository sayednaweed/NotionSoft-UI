import {
  WithToolTipState
} from "./chunk-SUAWIEG6.js";
import {
  ScrollArea2,
  require_jsx_runtime
} from "./chunk-SFV7D55D.js";
import {
  _extends,
  ...
  styled,
  typography
} from "./chunk-TQDUI3WN.js";
import {
  require_react_dom
} from "./chunk-HO3P54D2.js";
import {
  isTestEnvironment,
  sanitize
...
var LazySyntaxHighlighter = (0, import_react5.lazy)(async () => {
  const { SyntaxHighlighter: SyntaxHighlighter2 } = await import("./syntaxhighlighter-CAVLW7PM-DN66PUPV.js");
...
var LazySyntaxHighlighterWithFormatter = (0, import_react5.lazy)(async () => {
  const [{ SyntaxHighlighter: SyntaxHighlighter2 }, { formatter }] = await Promise.all([
    import("./syntaxhighlighter-CAVLW7PM-DN66PUPV.js"),
    import("./formatter-OMEEQ6HG-LZ6CQZ4V.js")
  ]);
  if (languages.length > 0) {
    languages.forEach((args) => {
      SyntaxHighlighter2.registerLanguage(...args);
...
var LazyWithTooltip = (0, import_react31.lazy)(
  () => import("./WithTooltip-SK46ZJ2J-ZBEWYMZ7.js").then((mod) => ({ default: mod.WithTooltip }))
);
...
var LazyWithTooltipPure = (0, import_react31.lazy)(
  () => import("./WithTooltip-SK46ZJ2J-ZBEWYMZ7.js").then((mod) => ({ default: mod.WithTooltipPure }))
);
...
//# sourceMappingURL=chunk-QWWEWEHO.js.map
