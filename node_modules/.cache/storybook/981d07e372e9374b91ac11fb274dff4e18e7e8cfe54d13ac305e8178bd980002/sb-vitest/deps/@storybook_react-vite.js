...
import {
  ...
  useEffect,
  useRef
} from "./chunk-5HURZLR5.js";
import {
  configure2
} from "./chunk-B2U4SMYZ.js";
import "./chunk-EGGX4Q2H.js";
import "./chunk-KX4Z7LMW.js";
import "./chunk-EXKM5OES.js";
import {
  logger,
  scope
} from "./chunk-XSNANC5T.js";
import "./chunk-YCSHCA5Q.js";
import {
  require_react
} from "./chunk-L2GV54VN.js";
import {
  __toESM
} from "./chunk-OL46QLBJ.js";

// node_modules/@storybook/react/dist/_browser-chunks/chunk-L5NVL7MD.js
...
// node_modules/@storybook/react/dist/_browser-chunks/chunk-BUAOEMNB.js
var import_react = __toESM(require_react(), 1);
var applyDecorators = __name((storyFn, decorators3) => {
  return defaultDecorateStory((context) => import_react.default.createElement(storyFn, context), decorators3);
}, "applyDecorators");

// node_modules/@storybook/react/dist/_browser-chunks/chunk-7HDTOAND.js
...
var getAct = __name(async ({ disableAct = false } = {}) => {
  if (disableAct) {
    return (cb) => cb();
  }
  let reactAct;
...
var _ErrorBoundary = class _ErrorBoundary2 extends import_react3.Component {
  constructor() {
    super(...arguments);
...
var actQueue = [];
var isActing = false;
var processActQueue = __name(async () => {
...
async function renderToCanvas({
  ...
  const { renderElement, unmountElement } = await import("./react-18-WN5CPUSM.js");
  const Story = unboundStoryFn;
  const isPortableStory = storyContext.parameters.__isPortableStory;
  const content = isPortableStory ? import_react3.default.createElement(Story, { ...storyContext }) : import_react3.default.createElement(ErrorBoundary, { key: storyContext.id, showMain, showException }, import_react3.default.createElement(Story, { ...storyContext }));
  const element = Wrapper ? import_react3.default.createElement(Wrapper, null, content) : content;
  if (forceRemount) {
...
var mount = __name((context) => async (ui) => {
  if (ui != null) {
...
// node_modules/@storybook/react/dist/_browser-chunks/chunk-VVH2AMAL.js
...
var require_dist = __commonJS({
  "../../node_modules/@base2/pretty-print-object/dist/index.js"(exports) {
    ...
    function prettyPrint2(input, options, pad) {
      ...
      var expandWhiteSpace = __name(function(string) {
        if (combinedOptions.inlineCharacterLimit === void 0) {
          return string;
        }
...
var isMemo = __name((component) => component.$$typeof === Symbol.for("react.memo"), "isMemo");
var isForwardRef = __name((component) => component.$$typeof === Symbol.for("react.forward_ref"), "isForwardRef");
function isObject(o) {
...
var spacer = __name(function(times, tabStop) {
  if (times === 0) {
    return "";
  }
...
var createStringTreeNode = __name(function createStringTreeNode2(value) {
  return {
    type: "string",
    value
  };
}, "createStringTreeNode");
var createNumberTreeNode = __name(function createNumberTreeNode2(value) {
  return {
    type: "number",
    value
  };
}, "createNumberTreeNode");
var createReactElementTreeNode = __name(function createReactElementTreeNode2(displayName, props, defaultProps, childrens) {
  return {
    type: "ReactElement",
    displayName,
    props,
...
var createReactFragmentTreeNode = __name(function createReactFragmentTreeNode2(key, childrens) {
  return {
    type: "ReactFragment",
    key,
    childrens
...
var supportFragment = Boolean(import_react4.Fragment);
var getFunctionTypeName = __name(function getFunctionTypeName2(functionType) {
  if (!functionType.name || functionType.name === "_default") {
    return "No Display Name";
  }
  return functionType.name;
}, "getFunctionTypeName");
var _getWrappedComponentDisplayName = __name(function getWrappedComponentDisplayName(Component) {
  switch (true) {
...
var getReactElementDisplayName = __name(function getReactElementDisplayName2(element) {
  switch (true) {
...
var noChildren = __name(function noChildren2(propsValue, propName) {
  return propName !== "children";
}, "noChildren");
var onlyMeaningfulChildren = __name(function onlyMeaningfulChildren2(children) {
  return children !== true && children !== false && children !== null && children !== "";
}, "onlyMeaningfulChildren");
var filterProps = __name(function filterProps2(originalProps, cb) {
  var filteredProps = {};
...
var _parseReactElement = __name(function parseReactElement(element, options) {
  ...
  } else if (!import_react4.default.isValidElement(element)) {
  ...
  var childrens = import_react4.default.Children.toArray(element.props.children).filter(onlyMeaningfulChildren).map(function(child) {
    return _parseReactElement(child, options);
  });
  if (supportFragment && element.type === import_react4.Fragment) {
...
var inlineFunction = __name(function inlineFunction2(fn) {
  return fn.toString().split("\n").map(function(line) {
    return line.trim();
  }).join("");
}, "inlineFunction");
var defaultFunctionValue = inlineFunction;
var formatFunction = __name(function(fn, options) {
...
var formatComplexDataStructure = __name(function(value, inline, lvl, options) {
  var normalizedValue = sortObject(value);
  var stringifiedValue = (0, import_pretty_print_object.prettyPrint)(normalizedValue, {
    transform: __name(function transform(currentObj, prop, originalResult) {
      var currentValue = currentObj[prop];
      if (currentValue && (0, import_react4.isValidElement)(currentValue)) {
...
var escape$1 = __name(function escape(s) {
  return s.replace(/"/g, "&quot;");
}, "escape");
var formatPropValue = __name(function formatPropValue2(propValue, inline, lvl, options) {
  ...
  if ((0, import_react4.isValidElement)(propValue)) {
...
var formatProp = __name(function(name, hasValue, value, hasDefaultValue, defaultValue, inline, lvl, options) {
...
var mergeSiblingPlainStringChildrenReducer = __name(function(previousNodes, currentNode) {
...
var isKeyOrRefProps = __name(function isKeyOrRefProps2(propName) {
  return ["key", "ref"].includes(propName);
}, "isKeyOrRefProps");
var sortPropsByNames = __name(function(shouldSortUserProps) {
...
var compensateMultilineStringElementIndentation = __name(function compensateMultilineStringElementIndentation2(element, formattedElement, inline, lvl, options) {
...
var formatOneChildren = __name(function formatOneChildren2(inline, lvl, options) {
...
var onlyPropsWithOriginalValue = __name(function onlyPropsWithOriginalValue2(defaultProps, props) {
...
var isInlineAttributeTooLong = __name(function isInlineAttributeTooLong2(attributes, inlineAttributeString, lvl, tabStop, maxInlineAttributesLineLength) {
...
var shouldRenderMultilineAttr = __name(function shouldRenderMultilineAttr2(attributes, inlineAttributeString, containsMultilineAttr, inline, lvl, tabStop, maxInlineAttributesLineLength) {
...
var formatReactElementNode = __name(function(node, inline, lvl, options) {
...
var toReactElementTreeNode = __name(function toReactElementTreeNode2(displayName, key, childrens) {
  var props = {};
  if (key) {
    props = {
      key
...
var isKeyedFragment = __name(function isKeyedFragment2(_ref) {
  var key = _ref.key;
  return Boolean(key);
}, "isKeyedFragment");
var hasNoChildren = __name(function hasNoChildren2(_ref2) {
  var childrens = _ref2.childrens;
  return childrens.length === 0;
}, "hasNoChildren");
var formatReactFragmentNode = __name(function(node, inline, lvl, options) {
...
var jsxStopChars = ["<", ">", "{", "}"];
var shouldBeEscaped = __name(function shouldBeEscaped2(s) {
  return jsxStopChars.some(function(jsxStopChar) {
    return s.includes(jsxStopChar);
  });
}, "shouldBeEscaped");
var escape2 = __name(function escape3(s) {
  if (!shouldBeEscaped(s)) {
    return s;
  }
  return "{`".concat(s, "`}");
}, "escape");
var preserveTrailingSpace = __name(function preserveTrailingSpace2(s) {
  var result = s;
  if (result.endsWith(" ")) {
...
var formatTreeNode = __name(function(node, inline, lvl, options) {
  if (node.type === "number") {
...
var formatTree = __name(function(node, options) {
  return formatTreeNode(node, false, 0, options);
}, "formatTree");
var reactElementToJsxString = __name(function reactElementToJsxString2(element) {
...
// node_modules/@storybook/react/dist/_browser-chunks/chunk-SKEPQA2F.js
var require_estraverse = __commonJS({
  "../../node_modules/estraverse/estraverse.js"(exports) {
    __name(function clone(exports2) {
      "use strict";
      ...
      Reference.prototype.replace = __name(function replace2(node) {
        this.parent[this.key] = node;
      }, "replace");
      Reference.prototype.remove = __name(function remove() {
      ...
      Controller.prototype.path = __name(function path() {
      ...
      Controller.prototype.parents = __name(function parents() {
        var i, iz, result;
        result = [];
      ...
      Controller.prototype.current = __name(function current() {
        return this.__current.node;
      }, "current");
      Controller.prototype.__execute = __name(function __execute(callback, element) {
        var previous, result;
        result = void 0;
      ...
      Controller.prototype.notify = __name(function notify(flag) {
        this.__state = flag;
      }, "notify");
      ...
      Controller.prototype.traverse = __name(function traverse2(root, visitor) {
      ...
      Controller.prototype.replace = __name(function replace2(root, visitor) {
      ...
      function extendCommentRange(comment, tokens) {
        var target;
        target = upperBound(tokens, __name(function search(token) {
...
var require_source_map_consumer = __commonJS({
  "../../node_modules/escodegen/node_modules/source-map/lib/source-map-consumer.js"(exports) {
    ...
    SourceMapConsumer.prototype._charIsMappingSeparator = __name(function SourceMapConsumer_charIsMappingSeparator(aStr, index) {
      var c = aStr.charAt(index);
      return c === ";" || c === ",";
    }, "SourceMapConsumer_charIsMappingSeparator");
    SourceMapConsumer.prototype._parseMappings = __name(function SourceMapConsumer_parseMappings(aStr, aSourceRoot) {
    ...
    SourceMapConsumer.prototype.eachMapping = __name(function SourceMapConsumer_eachMapping(aCallback, aContext, aOrder) {
    ...
    SourceMapConsumer.prototype.allGeneratedPositionsFor = __name(function SourceMapConsumer_allGeneratedPositionsFor(aArgs) {
  ...
  "../../node_modules/escodegen/escodegen.js"(exports) {
    (function() {
      ...
      CodeGenerator.Statement = {
        BlockStatement: __name(function(stmt, flags) {
        ...
        BreakStatement: __name(function(stmt, flags) {
          if (stmt.label) {
            return "break " + stmt.label.name + this.semicolon(flags);
          }
          return "break" + this.semicolon(flags);
        }, "BreakStatement"),
        ContinueStatement: __name(function(stmt, flags) {
          if (stmt.label) {
            return "continue " + stmt.label.name + this.semicolon(flags);
          }
          return "continue" + this.semicolon(flags);
        }, "ContinueStatement"),
        ClassBody: __name(function(stmt, flags) {
        ...
        ClassDeclaration: __name(function(stmt, flags) {
          var result, fragment;
          result = ["class"];
          if (stmt.id) {
        ...
        DirectiveStatement: __name(function(stmt, flags) {
          if (extra.raw && stmt.raw) {
            return stmt.raw + this.semicolon(flags);
          }
          return escapeDirective(stmt.directive) + this.semicolon(flags);
        }, "DirectiveStatement"),
        DoWhileStatement: __name(function(stmt, flags) {
        ...
        CatchClause: __name(function(stmt, flags) {
        ...
        DebuggerStatement: __name(function(stmt, flags) {
          return "debugger" + this.semicolon(flags);
        }, "DebuggerStatement"),
        EmptyStatement: __name(function(stmt, flags) {
          return ";";
        }, "EmptyStatement"),
        ExportDefaultDeclaration: __name(function(stmt, flags) {
        ...
        ExportNamedDeclaration: __name(function(stmt, flags) {
        ...
        ExportAllDeclaration: __name(function(stmt, flags) {
          return [
            "export" + space,
            "*" + space,
            "from" + space,
        ...
        ExpressionStatement: __name(function(stmt, flags) {
          var result, fragment;
        ...
        ImportDeclaration: __name(function(stmt, flags) {
        ...
        VariableDeclarator: __name(function(stmt, flags) {
        ...
        VariableDeclaration: __name(function(stmt, flags) {
        ...
        ThrowStatement: __name(function(stmt, flags) {
          return [join(
            "throw",
            this.generateExpression(stmt.argument, Precedence.Sequence, E_TTT)
          ), this.semicolon(flags)];
        }, "ThrowStatement"),
        TryStatement: __name(function(stmt, flags) {
        ...
        SwitchStatement: __name(function(stmt, flags) {
        ...
        SwitchCase: __name(function(stmt, flags) {
          var result, fragment, i, iz, bodyFlags, that = this;
          withIndent(function() {
            if (stmt.test) {
              result = [
        ...
        IfStatement: __name(function(stmt, flags) {
        ...
        ForStatement: __name(function(stmt, flags) {
          var result, that = this;
          withIndent(function() {
            result = ["for" + space + "("];
            if (stmt.init) {
        ...
        ForInStatement: __name(function(stmt, flags) {
          return this.generateIterationForStatement("in", stmt, flags & F_SEMICOLON_OPT ? S_TFFT : S_TFFF);
        }, "ForInStatement"),
        ForOfStatement: __name(function(stmt, flags) {
          return this.generateIterationForStatement("of", stmt, flags & F_SEMICOLON_OPT ? S_TFFT : S_TFFF);
        }, "ForOfStatement"),
        LabeledStatement: __name(function(stmt, flags) {
          return [stmt.label.name + ":", this.maybeBlock(stmt.body, flags & F_SEMICOLON_OPT ? S_TFFT : S_TFFF)];
        }, "LabeledStatement"),
        Program: __name(function(stmt, flags) {
        ...
        FunctionDeclaration: __name(function(stmt, flags) {
          return [
        ...
        ReturnStatement: __name(function(stmt, flags) {
          if (stmt.argument) {
            return [join(
              "return",
              this.generateExpression(stmt.argument, Precedence.Sequence, E_TTT)
        ...
        WhileStatement: __name(function(stmt, flags) {
          var result, that = this;
          withIndent(function() {
            result = [
              "while" + space + "(",
        ...
        WithStatement: __name(function(stmt, flags) {
          var result, that = this;
          withIndent(function() {
            result = [
              "with" + space + "(",
      ...
      CodeGenerator.Expression = {
        SequenceExpression: __name(function(expr, precedence, flags) {
          var result, i, iz;
        ...
        AssignmentExpression: __name(function(expr, precedence, flags) {
          return this.generateAssignment(expr.left, expr.right, expr.operator, precedence, flags);
        }, "AssignmentExpression"),
        ArrowFunctionExpression: __name(function(expr, precedence, flags) {
          return parenthesize(this.generateFunctionBody(expr), Precedence.ArrowFunction, precedence);
        }, "ArrowFunctionExpression"),
        ConditionalExpression: __name(function(expr, precedence, flags) {
        ...
        LogicalExpression: __name(function(expr, precedence, flags) {
          if (expr.operator === "??") {
            flags |= F_FOUND_COALESCE;
          }
          return this.BinaryExpression(expr, precedence, flags);
        }, "LogicalExpression"),
        BinaryExpression: __name(function(expr, precedence, flags) {
        ...
        CallExpression: __name(function(expr, precedence, flags) {
          var result, i, iz;
        ...
        ChainExpression: __name(function(expr, precedence, flags) {
        ...
        NewExpression: __name(function(expr, precedence, flags) {
        ...
        MemberExpression: __name(function(expr, precedence, flags) {
          var result, fragment;
        ...
        MetaProperty: __name(function(expr, precedence, flags) {
          var result;
          result = [];
        ...
        UnaryExpression: __name(function(expr, precedence, flags) {
        ...
        YieldExpression: __name(function(expr, precedence, flags) {
          var result;
          if (expr.delegate) {
            result = "yield*";
          } else {
        ...
        AwaitExpression: __name(function(expr, precedence, flags) {
          var result = join(
        ...
        UpdateExpression: __name(function(expr, precedence, flags) {
          if (expr.prefix) {
            return parenthesize(
              [
                expr.operator,
        ...
        FunctionExpression: __name(function(expr, precedence, flags) {
          var result = [
        ...
        ArrayPattern: __name(function(expr, precedence, flags) {
          return this.ArrayExpression(expr, precedence, flags, true);
        }, "ArrayPattern"),
        ArrayExpression: __name(function(expr, precedence, flags, isPattern) {
        ...
        RestElement: __name(function(expr, precedence, flags) {
          return "..." + this.generatePattern(expr.argument);
        }, "RestElement"),
        ClassExpression: __name(function(expr, precedence, flags) {
          var result, fragment;
          result = ["class"];
          if (expr.id) {
        ...
        MethodDefinition: __name(function(expr, precedence, flags) {
          var result, fragment;
          if (expr["static"]) {
            result = ["static" + space];
          } else {
        ...
        Property: __name(function(expr, precedence, flags) {
          if (expr.kind === "get" || expr.kind === "set") {
            return [
              expr.kind,
              noEmptySpace(),
        ...
        ObjectExpression: __name(function(expr, precedence, flags) {
        ...
        AssignmentPattern: __name(function(expr, precedence, flags) {
          return this.generateAssignment(expr.left, expr.right, "=", precedence, flags);
        }, "AssignmentPattern"),
        ObjectPattern: __name(function(expr, precedence, flags) {
        ...
        ThisExpression: __name(function(expr, precedence, flags) {
          return "this";
        }, "ThisExpression"),
        Super: __name(function(expr, precedence, flags) {
          return "super";
        }, "Super"),
        Identifier: __name(function(expr, precedence, flags) {
          return generateIdentifier(expr);
        }, "Identifier"),
        ImportDefaultSpecifier: __name(function(expr, precedence, flags) {
          return generateIdentifier(expr.id || expr.local);
        }, "ImportDefaultSpecifier"),
        ImportNamespaceSpecifier: __name(function(expr, precedence, flags) {
          var result = ["*"];
        ...
        ImportSpecifier: __name(function(expr, precedence, flags) {
        ...
        ExportSpecifier: __name(function(expr, precedence, flags) {
          var local = expr.local;
        ...
        Literal: __name(function(expr, precedence, flags) {
          var raw;
        ...
        GeneratorExpression: __name(function(expr, precedence, flags) {
          return this.ComprehensionExpression(expr, precedence, flags);
        }, "GeneratorExpression"),
        ComprehensionExpression: __name(function(expr, precedence, flags) {
        ...
        ComprehensionBlock: __name(function(expr, precedence, flags) {
          var fragment;
        ...
        SpreadElement: __name(function(expr, precedence, flags) {
          return [
            "...",
            this.generateExpression(expr.argument, Precedence.Assignment, E_TTT)
          ];
        }, "SpreadElement"),
        TaggedTemplateExpression: __name(function(expr, precedence, flags) {
          var itemFlags = E_TTF;
          if (!(flags & F_ALLOW_CALL)) {
            itemFlags = E_TFF;
          }
        ...
        TemplateElement: __name(function(expr, precedence, flags) {
          return expr.value.raw;
        }, "TemplateElement"),
        TemplateLiteral: __name(function(expr, precedence, flags) {
          var result, i, iz;
          result = ["`"];
        ...
        ModuleSpecifier: __name(function(expr, precedence, flags) {
          return this.Literal(expr, precedence, flags);
        }, "ModuleSpecifier"),
        ImportExpression: __name(function(expr, precedence, flag) {
          return parenthesize([
            "import(",
...
var require_acorn = __commonJS({
  "../../node_modules/acorn/dist/acorn.js"(exports, module) {
    (function(global2, factory) {
      ...
      var TokenType = __name(function TokenType2(label, conf) {
        if (conf === void 0) conf = {};
        this.label = label;
      ...
      var Position = __name(function Position2(line, col) {
        this.line = line;
        this.column = col;
      }, "Position");
      Position.prototype.offset = __name(function offset(n) {
        return new Position(this.line, this.column + n);
      }, "offset");
      var SourceLocation = __name(function SourceLocation2(p, start, end) {
        this.start = start;
        this.end = end;
      ...
      var Parser2 = __name(function Parser3(options, input, startPos) {
      ...
      Parser2.prototype.parse = __name(function parse3() {
      ...
      Parser2.prototype.inNonArrowFunction = __name(function inNonArrowFunction() {
        return (this.currentThisScope().flags & SCOPE_FUNCTION) > 0;
      }, "inNonArrowFunction");
      Parser2.extend = __name(function extend() {
      ...
      Parser2.parse = __name(function parse3(input, options) {
        return new this(options, input).parse();
      }, "parse");
      Parser2.parseExpressionAt = __name(function parseExpressionAt2(input, pos, options) {
        var parser = new this(options, input, pos);
        parser.nextToken();
        return parser.parseExpression();
      }, "parseExpressionAt");
      Parser2.tokenizer = __name(function tokenizer2(input, options) {
      ...
      pp$1.parseClassElement = function(constructorAllowsSuper) {
        ...
        var tryContextual = __name(function(k, noLineBreak) {
      ...
      var Scope = __name(function Scope2(flags) {
        this.flags = flags;
        this.var = [];
        this.lexical = [];
        this.functions = [];
      ...
      var Node = __name(function Node2(parser, pos, loc) {
        this.type = "";
        this.start = pos;
        this.end = 0;
      ...
      var TokContext = __name(function TokContext2(token, isExpr, preserveSpace, override, generator) {
        this.token = token;
        this.isExpr = !!isExpr;
      ...
      var RegExpValidationState = __name(function RegExpValidationState2(parser) {
        this.parser = parser;
      ...
      RegExpValidationState.prototype.reset = __name(function reset(start, pattern, flags) {
      ...
      RegExpValidationState.prototype.raise = __name(function raise(message) {
        this.parser.raiseRecoverable(this.start, "Invalid regular expression: /" + this.source + "/: " + message);
      }, "raise");
      RegExpValidationState.prototype.at = __name(function at(i, forceU) {
      ...
      RegExpValidationState.prototype.nextIndex = __name(function nextIndex(i, forceU) {
        if (forceU === void 0) forceU = false;
        var s = this.source;
        var l = s.length;
        if (i >= l) {
      ...
      RegExpValidationState.prototype.current = __name(function current(forceU) {
        if (forceU === void 0) forceU = false;
        return this.at(this.pos, forceU);
      }, "current");
      RegExpValidationState.prototype.lookahead = __name(function lookahead(forceU) {
        if (forceU === void 0) forceU = false;
        return this.at(this.nextIndex(this.pos, forceU), forceU);
      }, "lookahead");
      RegExpValidationState.prototype.advance = __name(function advance(forceU) {
        if (forceU === void 0) forceU = false;
        this.pos = this.nextIndex(this.pos, forceU);
      }, "advance");
      RegExpValidationState.prototype.eat = __name(function eat(ch, forceU) {
        if (forceU === void 0) forceU = false;
      ...
      var Token = __name(function Token2(p) {
        this.type = p.type;
        this.value = p.value;
        this.start = p.start;
        this.end = p.end;
...
var require_acorn_jsx = __commonJS({
  "../../node_modules/acorn-jsx/index.js"(exports, module) {
    ...
    Object.defineProperty(module.exports, "tokTypes", {
      get: __name(function get_tokTypes() {
...
function simple(node, visitors, baseVisitor, state, override) {
  ...
  __name(function c(node2, st, override2) {
...
var stringResolver = __name((rawDefaultProp) => {
...
var objectResolver = __name((rawDefaultProp) => {
...
var functionResolver = __name((rawDefaultProp, propDef) => {
  let isElement = false;
...
var defaultResolver = __name((rawDefaultProp) => {
...
var funcResolver = __name((rawDefaultProp, { name, type }) => {
...
var extractProps = __name((component) => ({
...
// node_modules/@storybook/react/dist/_browser-chunks/chunk-HBQ5Y6GW.js
...
var toPascalCase = __name((str) => str.charAt(0).toUpperCase() + str.slice(1), "toPascalCase");
var getReactSymbolName = __name((elementType) => {
...
var renderJsx = __name((code, options) => {
  ...
  for (let i = 0; i < options?.skip; i += 1) {
    ...
    if (typeof renderedJSX.props.children === "undefined") {
      ...
      if (typeof renderedJSX.type === "function" && renderedJSX.type.name === "") {
        renderedJSX = import_react5.default.createElement(Type, { ...renderedJSX.props });
      }
  ...
  if (typeof options?.displayName === "string") {
    displayNameDefaults = { showFunctions: true, displayName: __name(() => options.displayName, "displayName") };
  } else {
    displayNameDefaults = {
      // To get exotic component names resolving properly
      displayName: __name((el) => {
  ...
  const filterDefaults = {
    filterProps: __name((value, key) => value !== void 0, "filterProps")
  };
  const opts = {
    ...displayNameDefaults,
    ...filterDefaults,
  ...
  const result = import_react5.default.Children.map(code, (c) => {
    const child = typeof c === "number" ? c.toString() : c;
    const toJSXString = typeof reactElementToJSXString2 === "function" ? reactElementToJSXString2 : (
      // @ts-expect-error (Converted from ts-ignore)
...
var skipJsxRender = __name((context) => {
...
var isMdx = __name((node) => node.type?.displayName === "MDXCreateElement" && !!node.props?.mdxType, "isMdx");
var mdxToJsx = __name((node) => {
  if (!isMdx(node)) {
    return node;
  }
  ...
  return (0, import_react5.createElement)(originalType, rest, ...jsxChildren);
}, "mdxToJsx");
var jsxDecorator = __name((storyFn, context) => {
...
var applyDecorators2 = __name((storyFn, decorators22) => {
  const jsxIndex = decorators22.findIndex((d) => d.originalFn === jsxDecorator);
  const reorderedDecorators = jsxIndex === -1 ? decorators22 : [...decorators22.splice(jsxIndex, 1), ...decorators22];
...
// node_modules/@storybook/react/dist/_browser-chunks/chunk-O24TFCLO.js
...
var INTERNAL_DEFAULT_PROJECT_ANNOTATIONS = composeConfigs([
  ...
  {
    /** @deprecated */
    renderToCanvas: __name(async (renderContext, canvasElement) => {
      ...
      const { unmount } = render2(React7.createElement(Story, { ...context }), { container: context.canvasElement });
      return unmount;
    }, "renderToCanvas")
  }
]);
